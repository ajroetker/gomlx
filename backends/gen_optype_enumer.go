...
const _OpTypeName = ""

var _OpTypeIndex = [...]uint16{0, 7, 16, 24, 32, 44, 59, 80, 100, 117, 125, 128, 131, 140, 147, 157, 167, 176, 186, 195, 209, 214, 218, 221, 228, 239, 243, 254, 266, 269, 272, 275, 285, 297, 315, 320, 335, 338, 341, 346, 349, 354, 360, 374, 398, 409, 430, 434, 438, 446, 451, 462, 483, 491, 509, 512, 517, 527, 537, 546, 556, 564, 567, 570, 573, 576, 584, 602, 605, 608, 612, 628, 643, 659, 675, 690, 706, 715, 724, 737, 746, 749, 756, 763, 768, 773, 783, 793, 803, 822, 841, 860, 869, 889, 906, 910, 913, 918, 922, 925, 929, 938, 943, 952, 961, 974, 993, 1010, 1019, 1030, 1034}

const _OpTypeLowerName = ""
...
var _OpTypeNameToValueMap = map[string]OpType{
	...
	_OpTypeName[952:961]:        OpTypeAllGather,
	_OpTypeLowerName[952:961]:   OpTypeAllGather,
	_OpTypeName[961:974]:        OpTypeReduceScatter,
	_OpTypeLowerName[961:974]:   OpTypeReduceScatter,
	_OpTypeName[974:993]:        OpTypeCollectiveBroadcast,
	_OpTypeLowerName[974:993]:   OpTypeCollectiveBroadcast,
	_OpTypeName[993:1010]:       OpTypeCollectivePermute,
	_OpTypeLowerName[993:1010]:  OpTypeCollectivePermute,
	_OpTypeName[1010:1019]:      OpTypeReplicaId,
	_OpTypeLowerName[1010:1019]: OpTypeReplicaId,
	_OpTypeName[1019:1030]:      OpTypePartitionId,
	_OpTypeLowerName[1019:1030]: OpTypePartitionId,
	_OpTypeName[1030:1034]:      OpTypeLast,
	_OpTypeLowerName[1030:1034]: OpTypeLast,
}
...
var _OpTypeNames = []string{
	...
	_OpTypeName[961:974],
	_OpTypeName[974:993],
	_OpTypeName[993:1010],
	_OpTypeName[1010:1019],
	_OpTypeName[1019:1030],
	_OpTypeName[1030:1034],
}
